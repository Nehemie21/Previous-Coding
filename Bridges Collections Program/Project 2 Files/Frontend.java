...
public class Frontend {
	...
	private BackendInterfaceMapper start;
	//The destination
	private BackendInterfaceMapper end;
	...
	private double pathWalkingTime = 0;
	...
	//List of all the buildings in dataSet
	private LinkedList<String> buildings = null;
	
	//The shortest path
	private LinkedList<String> shortestPath = null;
	...
	private final String noSuchPath = LINEBREAK+
			...
			+LINEBREAK;
	//If no nodes are put in
//	private String VIEWMESSAGE = LINEBREAK
//			+"\n| No node entry put in yet "
//			+ "\n| Put in a start and end for program to continue"
//			+LINEBREAK;
	
	//If mode number exceeds the current mode options
	private final String indexOutOfBoundsMessage = LINEBREAK+
			"\n| --------------------------------Error - Index Out of Bounds--------------------------------"
			+LINEBREAK;
			...
			+"\\n| Press 'c': Category Function - Displays distance to a category (i.e. libraries)\"\r\n" 
